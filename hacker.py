...
{A}║                                        _|"""""| _|"""""| _|"""""| 
{A}║                                        "`-0-0-' "`-0-0-' "`-0-0-'                                 {A}║
{A}║                                                                {A}VERSION{P}: {H}BETA.01        {A}║
{A}║                                                                                        {A}║
{A}╚════════════════════════════════════════════════════════════════════════════════════════╝

{A}╔════════════════════════════════════════════════════════════════════════════════════════╗
{A}║                            {O} MULTI {K}BRUTEFORCE {U}INSTAGRAM                                 {A}║
{A}║                            {A} AUTHOR    {P}: {H} SAD BOY                                    {A}║
{A}║                            {A} Github    {P}: {H}MR BALOCH 007                         {A}║
{A}║                            {A} Facebook  {P}: {H}MR BALOCH                               {A}║
{A}╚════════════════════════════════════════════════════════════════════════════════════════╝
""")                                                                                                         
#Licensi
___licensi___ = (f"""{H}
...
def xoshnaw():
  ...
  try:
    httpCaht = requests.get("https://github.com/Mr-Qureshi-xd/Aproval/blob/main/Aproval.txt").text
    if id in httpCaht:
